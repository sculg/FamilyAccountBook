//
//  UINavigationBar+FABHidBottomLine.m
//  FamilyAccountBook
//
...
@implementation UINavigationBar (FABHidBottomLine)
...
- (void)setHiddenBottom:(BOOL)hiddenBottom {
    objc_setAssociatedObject(self, &hiddenBottom_key, @(hiddenBottom), OBJC_ASSOCIATION_ASSIGN);
}
