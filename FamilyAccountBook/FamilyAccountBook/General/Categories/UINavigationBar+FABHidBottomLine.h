//
//  UINavigationBar+FABHidBottomLine.h
//  FamilyAccountBook
//
...
@interface UINavigationBar (FABHidBottomLine)
/**
 更改导航栏颜色和图片
 ...
 */
- (void)navBarBackGroundColor:(UIColor *_Nullable)color
                        image:(UIImage *_Nullable)barImage
